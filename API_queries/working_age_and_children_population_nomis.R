...
write.csv(wa_population_with_totals, "data/working_age_population.csv", row.names = FALSE)
write.csv(children_population_with_totals, "data/children_population.csv", row.names = FALSE)
