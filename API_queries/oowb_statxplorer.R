...
population <- read.csv("data/working_age_population.csv")
...
results_recent <- statxplorer::fetch_table(filename = "json/oowb_combinations_08_22.json")
#data from 2013-2018:
results_historic <- statxplorer::fetch_table(filename = "json/oowb_historic_08_22.json")
...
write.csv(oowb_proportions, "data/oowb_data.csv", row.names = FALSE)
