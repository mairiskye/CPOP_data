...
codes <- read.csv("code_lookup.csv") %>%
...
write.csv(s01, file = "data/edu_attainment_dz_data.csv", row.names = FALSE)
write.csv(s02, file = "data/edu_attainment_iz_data.csv", row.names = FALSE)
write.csv(s12, file = "data/edu_attainment_cpp_data.csv", row.names = FALSE)
